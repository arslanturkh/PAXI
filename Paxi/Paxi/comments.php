...
<div class="container-fluid bg-1 text-center">
  ...
  <?php 
    ...
    $result = mysqli_query($con, "SELECT user.*, comment.*, taxi.* FROM user INNER JOIN comment ON comment.userid = user.userid   INNER JOIN taxi  ON comment.taxiid = taxi.taxiid WHERE user.userid = $intUserId");
